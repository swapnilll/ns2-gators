...
The following code is my current 100-node AODV simulator (filename testAODV.tcl).  The code creates a trace file (testAODV.tr) and nam file (testAODV.nam).  I also have files that successfully run DSR and DSDV (just change the routing protocol and output file names).

The node starting positions, destinations, and travel speeds are random.
